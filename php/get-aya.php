...
// $option = $_GET['option'];
$transFile = $_POST['transType'] . '.txt';  // translation file
$res = array(
    'pageNum' => $_POST['pageNum'],
    "quranType" => $_POST['type'],
    "transType" => $_POST['transType'],
    "quran" => getAyas($quranFile, $_POST['startAya'], $_POST['endAya']),
    "trans" => getAyas($transFile, $_POST['startAya'], $_POST['endAya'])
    );
// if ( $option == 1 ) {
    // $data = [ 'a', 'b', 'c' ];
